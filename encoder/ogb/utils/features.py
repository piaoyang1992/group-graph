allowable_features = {
    ...
    'possible_sum_atom':list(range(100)),
    'possible_inter_num':list(range(100))
}
...
def atom_to_feature_vector(atom):
    ...
    """
    if atom == -1:
        atom_feature = [0,0,0,0,0,0,0,0,0]
    else:
        atom_feature = [
...
def get_atom_feature_dims():
    return list(map(len, [
        ...
        allowable_features['possible_sum_atom'],
        allowable_features['possible_inter_num']
        ]))

'''
def get_inter_feature_dims():
    return list(map(len, [
        allowable_features['possible_is_inter'],
        allowable_features['possible_inter_num']
        ]))
'''
